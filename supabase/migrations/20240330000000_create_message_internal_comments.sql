...
CREATE INDEX idx_message_internal_comments_workspace_id ON message_internal_comments(workspace_id);
...
COMMENT ON COLUMN message_internal_comments.workspace_id IS 'ID of the workspace this comment belongs to';
