...
CREATE INDEX idx_portfolio_data_workspace_id ON portfolio_data(workspace_id);
...
CREATE INDEX idx_portfolio_analysis_results_workspace_id ON portfolio_analysis_results(workspace_id);
